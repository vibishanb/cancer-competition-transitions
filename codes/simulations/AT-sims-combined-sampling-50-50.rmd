...
def sim_adaptive_therapy(parms_array):
  ...
  return y_ss, run_params, period, popsize_ss
...
if __name__ == '__main__':
    ...
    pool = Pool(10)
    all_data = pool.map(sim_adaptive_therapy, no_treat) #iterate over combinations
    pool.close()
    pool.join()
...
df_results.loc[:, 'Period'] = period
df_results.loc[:, 'PopSizeSS'] = ss_popsize
df_results.to_csv('../../analysis/adaptive-therapy/no-therapy-outcomes-r3.csv')

# Cytostatic 1: g/3
if __name__ == '__main__':
    __spec__ = "ModuleSpec(name='builtins', loader=<class '_frozen_importlib.BuiltinImporter'>)"
    pool = Pool(10)
    all_data = pool.map(sim_adaptive_therapy, st1) #iterate over combinations
    pool.close()
    pool.join()
...
df_results.loc[:, 'Period'] = period
df_results.loc[:, 'PopSizeSS'] = ss_popsize
df_results.to_csv('../../analysis/adaptive-therapy/AT-cytostatic-0.33-zero-delay-r3.csv')

# Cytostatic 2: g/10
if __name__ == '__main__':
    __spec__ = "ModuleSpec(name='builtins', loader=<class '_frozen_importlib.BuiltinImporter'>)"
    pool = Pool(10)
    all_data = pool.map(sim_adaptive_therapy, st2) #iterate over combinations
    pool.close()
    pool.join()
...
df_results.loc[:, 'Period'] = period
df_results.loc[:, 'PopSizeSS'] = ss_popsize
df_results.to_csv('../../analysis/adaptive-therapy/AT-cytostatic-0.1-zero-delay-r3.csv')

# Cytotoxic 1: d_th = 0.01
if __name__ == '__main__':
    __spec__ = "ModuleSpec(name='builtins', loader=<class '_frozen_importlib.BuiltinImporter'>)"
    pool = Pool(10)
    all_data = pool.map(sim_adaptive_therapy, tx1) #iterate over combinations
    pool.close()
    pool.join()
...
df_results.loc[:, 'Period'] = period
df_results.loc[:, 'PopSizeSS'] = ss_popsize
df_results.to_csv('../../analysis/adaptive-therapy/AT-cytotoxic-0.01-zero-delay-r3.csv')

# Cytotoxic 2: d_th = 0.05
if __name__ == '__main__':
    __spec__ = "ModuleSpec(name='builtins', loader=<class '_frozen_importlib.BuiltinImporter'>)"
    pool = Pool(10)
    all_data = pool.map(sim_adaptive_therapy, tx2) #iterate over combinations
    pool.close()
    pool.join()
...
df_results.loc[:, 'Period'] = period
df_results.loc[:, 'PopSizeSS'] = ss_popsize
df_results.to_csv('../../analysis/adaptive-therapy/AT-cytotoxic-0.05-zero-delay-r3.csv')
```
